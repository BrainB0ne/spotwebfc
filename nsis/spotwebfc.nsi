...
!define COMPANYNAME "SpotwebFC"
!define DESCRIPTION "Create spotweb filters the easy way!"
...
section "install"
	...
	createShortCut "$SMPROGRAMS\${COMPANYNAME}\${APPNAME}.lnk" "$INSTDIR\spotwebfc.exe" "" "$INSTDIR\logo.ico"
